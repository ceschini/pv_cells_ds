...
function [transImg, Dotau, A, E, f, tfm_matrix, focus_size, error_sign, UData, VData, XData, YData, A_scale]=TILT(varargin)
% Version info: v 1.04
% -------------------------------------------------------------------------
...
focus_threshold=100; %!!!!!!!!!!!!!!!!!! The max length of the focus is 100, if too large downsample to matrix of this size.
...
transImg = aligned_focus;
%imwrite(aligned_focus,'2trans.jpg') %
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!(4)
